...
// BlueprintServiceAPIService BlueprintServiceAPI service
type BlueprintServiceAPIService service

type ApiHandleBlueprintServiceCreatedRequestRequest struct {
	ctx context.Context
	ApiService *BlueprintServiceAPIService
	organization string
	cluster string
	project string
	environment string
...
/*
HandleBlueprintServiceCreatedRequest Method for HandleBlueprintServiceCreatedRequest
 ...
 @param project
 @param environment
 @return ApiHandleBlueprintServiceCreatedRequestRequest
*/
func (a *BlueprintServiceAPIService) HandleBlueprintServiceCreatedRequest(ctx context.Context, organization string, cluster string, project string, environment string) ApiHandleBlueprintServiceCreatedRequestRequest {
	return ApiHandleBlueprintServiceCreatedRequestRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *BlueprintServiceAPIService) HandleBlueprintServiceCreatedRequestExecute(r ApiHandleBlueprintServiceCreatedRequestRequest) (string, *http.Response, error) {
	...
	localVarPath := localBasePath + "/blueprint/service-created"
