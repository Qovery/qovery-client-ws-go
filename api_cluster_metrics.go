...
type ApiHandleClusterMetricsRequestRequest struct {
	ctx context.Context
...
/*
HandleClusterMetricsRequest Method for HandleClusterMetricsRequest

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param organization
 @param cluster
 @return ApiHandleClusterMetricsRequestRequest
*/
func (a *ClusterMetricsAPIService) HandleClusterMetricsRequest(ctx context.Context, organization string, cluster string) ApiHandleClusterMetricsRequestRequest {
	return ApiHandleClusterMetricsRequestRequest{
		ApiService: a,
		ctx: ctx,
